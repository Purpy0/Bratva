              ...
              {campaignInfo && !campaignIsUninitialized ? (
                ...
                <Box w="full" textAlign="center" py={8}>
                  ...
                  >
                    ...
                    <Box w="100%" h="16px" bg="gray.200" borderRadius="full" overflow="hidden" mb={2}>
                      <Box w="42%" h="100%" bgGradient="linear(to-r, green.400, green.600)" borderRadius="full" transition="width 1s" />
                    </Box>
                    <Box textAlign="right" fontSize="sm" color="gray.500">
                      42% of goal reached
                    </Box>
                  </Box>
                </Box>
